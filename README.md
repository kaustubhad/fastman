...
* **gap.axis** = A numeric factor that determines the minimal gaps between axis labels, defaults to NA. The default value corresponds to tick labels drawn parallel to the axis.
